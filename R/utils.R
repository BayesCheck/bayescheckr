...
#' likelihood
#'
#'Draws N times from the likelyhood using the draw from the prior
...
#' NOTE: format the output later
#' @param y the vector of likelyhood draws
#' @param n_obs number of observations
#' @param posterior_input_function whatever the user thinks the posterior draws are supposed to be.
#' @param prior_hyperparams the vector of hyperparameters
posterior_input_sampler <- function(y, n_obs, posterior_input_function, prior_hyperparams){
